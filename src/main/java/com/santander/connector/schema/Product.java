...
public class Product   {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(capCodes, defaultCurrency, defaultRate, manufacturerDepositContribution, marketIso, maxPayment, productDesc, productEndDate, productFees, productId, productOnline, productStartDate, productTypeDesc, productTypeId, productValidations);
  }
  ...
  public String toString() {
    ...
    sb.append("    manufacturerDepositContribution: ").append(toIndentedString(manufacturerDepositContribution)).append("\n");
